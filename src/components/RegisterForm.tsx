  ...
  <Container>
    <form method='POST'>
        <div>
            ...
            <div className='image-box'>
                <div className='credentials'>
                    <StyledInput type="text" placeholder='E-mail'></StyledInput>
                    <StyledInput type="password" placeholder='Hasło'></StyledInput>
                </div>
                <div>
                    <p>Zdobądź status zweryfikowanego użytkownika TourOn dodając zdjęcie swojego dowodu</p>
                    <img src={star} />
                </div>
                <img src={camera} />
            </div>
        ...
        <div className="checkbox-container">
            ...
            <label htmlFor="terms"> zaakceptuj <a href="#">regulamin</a> TourOn</label>
        </div>
